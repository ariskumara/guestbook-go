...
func main() {
	...
	masterPool = simpleredis.NewConnectionPoolHost(os.Getenv("REDIS_MASTER_SERVICE_HOST") + ":" + os.Getenv("REDIS_MASTER_SERVICE_PORT"))
	defer masterPool.Close()

	//slavePool = simpleredis.NewConnectionPoolHost("redis-slave:6379")

	slavePool = simpleredis.NewConnectionPoolHost(os.Getenv("REDIS_SLAVE_SERVICE_HOST") + ":" + os.Getenv("REDIS_SLAVE_SERVICE_PORT"))
