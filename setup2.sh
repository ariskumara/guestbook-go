...
kubectl delete svc/guestbook-svc-blue svc/guestbook-svc-green svc/redis-master svc/redis-slave -n guestbook-ns
kubectl delete deploy/guestbook-deploy-blue deploy/guestbook-deploy-green deploy/redis-master deploy/redis-slave -n guestbook-ns
